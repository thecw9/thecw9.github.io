...
- [Vantage](https://instances.vantage.sh/): A free and easy-to-use tool for comparing EC2 Instance features and prices.

## 搜索工具

- [ChatGPT](https://chat.openai.com/): ChatGPT 是一个大型语言模型，可以与人类进行自然语言交互并回答各种问题。[工作原理](https://writings.stephenwolfram.com/2023/02/what-is-chatgpt-doing-and-why-does-it-work/)
...
- [X-MOL](https://www.x-mol.com/): x-mol 科学知识平台，顶级期刊论文图文内容每日更新。
